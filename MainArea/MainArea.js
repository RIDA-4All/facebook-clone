                ...
                <div className="addStory">
                    ...
                    <div className="message">
                        <div className="text">
                            <div className="Post">
                                ...
                                <input type="Mind" placeholder="What's on your mind, Rida?"/>
                            </div>
                            <div className="Call">
                                <div className="ico">
                                    <div className="icone">
                    ...
                    <div className="Posted">
                        <div className="poster">
                            <div className="Codcrafters">
                                <img src="/images/codcrafter.jpeg" alt="Img" style={{height:"50px", width:"50px", borderRadius:"50%"}}/>
                                Codcrafters
                        ...
                        <div className="FacebookImg">
                            <img src="/images/codcrafter.jpeg" alt="dp" style={{height:"auto",width:"100%"}}/>
                        </div>
